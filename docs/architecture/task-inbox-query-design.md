...
- [任务列表组装](../../workflow-server/workflow-process/src/main/java/com/workflow/process/task/api/web/ProcessTaskController.java)、[现有过滤口径](../../workflow-server/workflow-process/src/main/java/com/workflow/process/task/application/TaskListFilter.java)、[实体事务执行器](../../workflow-server/workflow-entity/src/main/java/com/workflow/entity/mutation/application/EntityMutationTransactionExecutor.java)。
