...
> 2026-09-20 退役说明：发布候选功能已整体下线，V099 清理其专属菜单、授权和六张表。下文候选实现与测试结论仅适用于历史版本；普通配置迁移的导入、导出、发布和批次回滚继续保留。

> 历史说明：本文记录 2026-08 阶段交付。原“节点操作矩阵”已于 2026-09-09
> 被[节点操作权限三开关方案](./node-operation-permission-simplification.md)替代；下文矩阵内容仅用于追溯旧版本。
