...
summary=$(jq '
  def metric($name; $field): .metrics[$name].values[$field] // null;
  {
    ...
    auth_traffic_p95_ms: metric("flow_auth_duration{operation:login_traffic}"; "p(95)"),
    auth_traffic_p99_ms: metric("flow_auth_duration{operation:login_traffic}"; "p(99)"),
    auth_all_p99_ms: metric("flow_auth_duration"; "p(99)"),
