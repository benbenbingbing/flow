...
const entries = (await Promise.all([contractsRoot, path.join(frontendRoot, 'src/extensions/templates'), path.join(frontendRoot, 'src/extensions/examples/contracts')].map(collectEntries))).flat()
