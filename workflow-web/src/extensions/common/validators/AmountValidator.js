...
export class AmountValidator extends CustomValidator {
   ...
   * @param {import('../../contracts/validation.js').ValidationContext} [context={}] params.maxAmount 为可选额度。
   * @returns {import('../../contracts/validation.js').ValidationOutcome} true 通过，否则返回错误文本。
