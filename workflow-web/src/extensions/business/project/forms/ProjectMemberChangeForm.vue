    ...
    >
      <div class="form-layout">
        <main>
          ...
          <ProjectMemberChangeSections
            :local-value="localValue"
            :is-join="isJoin"
            :is-leave="isLeave"
            :operation-section-title="operationSectionTitle"
            :operation-section-description="operationSectionDescription"
            :field-for="fieldFor"
            :is-disabled="isDisabled"
            :field-context="fieldContext"
            :data-source-runtime="dataSourceRuntime"
            :sync-and-load="syncAndLoad"
            :sync-value="syncValue"
            :requires-planned-leave="requiresPlannedLeave"
            :member-context="memberContext"
            :shows-allocation="showsAllocation"
            :allocation-total="allocationTotal"
            :allocation-percentage="allocationPercentage"
            :allocation-current="allocationCurrent"
            :allocation-requested="allocationRequested"
            :allocation-available="allocationAvailable"
            :shows-access-change="showsAccessChange"
            :route-flags="routeFlags"
            :handover-alert-title="handoverAlertTitle"
