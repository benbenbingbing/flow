      ...
      topics: [
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              tone: 'warning',
              title: '离开页面前',
              text: '右侧节点面板共用一个“应用到画布”，会统一校验并应用当前节点或连线的全部配置，但不会单独提交数据库。完成配置后，还要点击顶部“保存草稿”。'
            }
          ]
        },
        {
        ...
        },
        {
          ...
          title: '节点配置页签与首屏原则',
          lead: '点击流程节点会自动打开右侧属性抽屉。页签按节点能力动态显示，最多为“常用、协同、高级、流程动作”；不适用于当前节点的页签不会显示。',
          blocks: [
            {
              type: 'callout',
              tone: 'info',
            ...
            },
            {
              ...
              tone: 'info',
              title: '按节点适用',
              text: '“常用、协同、高级、流程动作”是页签上限，不表示所有节点都必须显示四个。连线只有“常用、流程动作”，常用中包含条件和实体状态。'
            }
          ]
        },
        {
          ...
          blocks: [
            {
              ...
              rows: [
                ...
                { field: '节点 ID', meaning: 'BPMN 元素技术标识，位于“标识与备注”折叠区。', defaultLimit: '只读，由设计器生成。', effect: '用于节点表单、审批配置、状态映射、动作绑定和日志。', publish: '发布后删除重建会产生新 ID，历史配置不会自动迁移。' },
                { field: '说明文档', meaning: 'BPMN documentation，位于“标识与备注”折叠区。', defaultLimit: '可选多行。', effect: '写入 XML，供设计审计。', publish: '建议记录进入条件、处理要求、输出和异常路径。' }
              ]
            }
          ]
        }
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                '点击连线面板底部“应用到画布”会和流转条件一起更新 BPMN 扩展属性及后端状态映射；顶部仍需保存草稿 XML。',
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              text: 'HOTFIX 发布和撤回都只需要 entity:ui-config:hotfix；REVIEW 仅提示风险，不阻止发布。发布历史中 ACTIVE 表示正在生效且可撤回，SUPERSEDED 表示已被更新热修复替代，ROLLED_BACK 表示已撤回；只有 ACTIVE 提供撤回入口。'
            },
            {
              type: 'callout',
              tone: 'warning',
