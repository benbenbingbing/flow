...
const KEY_GUIDANCE = Object.freeze({
  ...
  extensionId: ['选择一条受管理的扩展接口。', '10001', '运行时按发布快照执行这条接口，权限和输入输出由接口定义约束。'],
  interfaceExtensionId: ['选择字段或节点使用的扩展接口。', '10001', '运行时只调用所选扩展接口的已发布定义和受控 Provider。'],
...
const EVIDENCE_BY_AREA = Object.freeze({
  ...
  '事件绑定': 'src/components/ui-config/__tests__/interfaceExtensionModel.spec.js；workflow-entity UiEventBindingServiceRevisionTest',
