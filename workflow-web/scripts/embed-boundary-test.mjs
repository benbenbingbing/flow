...
const sharedRequestSource = await source('src/shared/request/index.js') + await readFile(new URL(import.meta.resolve('@flow/workflow-api/request')), 'utf8')
...
assert.match(sharedRequestSource, /function configureEmbedDelegatedRequest/)
assert.match(sharedRequestSource, /function resetEmbedDelegatedRequest/)
