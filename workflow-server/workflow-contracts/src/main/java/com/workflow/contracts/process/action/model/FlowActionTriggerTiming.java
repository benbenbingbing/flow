...
public enum FlowActionTriggerTiming {
     ...
     * 是否仅限用户任务节点使用
     *
     * @return 用户任务仅条件成立时为 true，否则为 false
     */
     ...
     * 获取默认执行方式
     *
     * @return 符合条件的流程动作执行模式结果，供调用方继续处理
     */
     ...
     * 获取默认失败策略
     *
     * @return 符合条件的流程动作失败策略结果，供调用方继续处理
     */
