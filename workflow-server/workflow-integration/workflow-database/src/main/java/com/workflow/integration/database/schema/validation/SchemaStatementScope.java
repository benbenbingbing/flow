...
public final class SchemaStatementScope {
    /**
     * 初始化结构{@code statement}作用域，保存构造参数供后续方法使用。
     */
     ...
     * @param dialect 方言，供本方法校验并获取业务{@code statement}时使用
     */
    ...
    /**
     * 判断业务表条件是否成立，供调用方选择后续分支。
     *
     * @param name 名称，后续用于处理业务表时匹配或展示
     * @return 业务表条件成立时为 true，否则为 false
     */
