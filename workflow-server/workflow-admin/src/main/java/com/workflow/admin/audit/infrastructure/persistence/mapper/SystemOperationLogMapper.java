package com.workflow.admin.audit.infrastructure.persistence.mapper;
...
public interface SystemOperationLogMapper extends BaseMapper<SystemOperationLog> {
    ...
    default int deleteExpiredBatch(java.time.LocalDateTime cutoff, int limit) {
        ...
        var ids = selectList(new com.workflow.core.database.mybatis.OffsetPage<SystemOperationLog>(0, limit),
