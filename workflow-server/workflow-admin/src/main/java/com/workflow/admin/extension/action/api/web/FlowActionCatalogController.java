...
public class FlowActionCatalogController {

    private final FlowActionCatalogService definitionService;
     ...
     */
    @GetMapping
    public Result<List<FlowActionHandlerOption>> listHandlers(
     ...
     */
    @GetMapping("/configs")
    public Result<List<FlowActionHandlerOption>> listConfigs() {
