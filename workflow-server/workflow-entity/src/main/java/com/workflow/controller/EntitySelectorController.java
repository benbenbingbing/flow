...
public class EntitySelectorController {
    ...
    public Result<Map<String, Object>> getById(
        ...
        if ("CUSTOM".equalsIgnoreCase(entityType)) {
            ...
            data = entityDataDynamicService.findAccessibleById(actualEntityCode, id, null).getData();
            if (data != null) {
    ...
    public Result<List<Map<String, Object>>> getBatch(
        ...
        if ("CUSTOM".equalsIgnoreCase(entityType)) {
            ...
            for (String id : idList) {
                try {
                    Map<String, Object> data = entityDataDynamicService
                            .findAccessibleById(actualEntityCode, id.trim(), null)
                            .getData();
                    if (data != null) {
