...
public interface EntityDataDynamicMapper {
     ...
     * @return 影响行数
     */
    @InsertProvider(type = com.workflow.entity.data.infrastructure.persistence.provider.EntityDataSqlProvider.class, method = "insert")
    @Options(statementType = StatementType.PREPARED)
     ...
     * @return 影响行数
     */
    @UpdateProvider(type = com.workflow.entity.data.infrastructure.persistence.provider.EntityDataSqlProvider.class, method = "update")
    @Options(statementType = StatementType.PREPARED)
     ...
     * @return 流程实例记录总数
     */
    @SelectProvider(type = com.workflow.entity.data.infrastructure.persistence.provider.EntityDataSqlProvider.class, method = "countProcessInstances")
    @Options(statementType = StatementType.PREPARED)
