...
public class ProcessDefinitionController {
    ...
    public ApiResponse<List<ProcessDefinitionDTO>> listPublished() {
        return ApiResponse.success(processService.findByStatus(com.workflow.process.definition.infrastructure.persistence.record.ProcessDefinitionConfig.ProcessStatus.PUBLISHED));
    }
