        ...
        public void onEvent(FlowableEvent event) {
                ...
                if (entity instanceof TaskEntity) {
                        ...
                        try {
                                ...
                                // 获取流程变量
                                String entityCode = (String) runtimeService.getVariable(processInstanceId,
                                                "entityCode");
                                String entityDataId = (String) runtimeService.getVariable(processInstanceId,
                                                "entityDataId");
                                ...
                                ProcessDefinitionConfig processConfig = processConfigMapper
                                                .findByProcessKey(processDefinitionKey)
                                                .orElse(null);
                                ...
                                EntityFlowStatusMapping mapping = mappings.stream()
                                                .filter(m -> m.getEntityStatusCode() != null
                                                                && !m.getEntityStatusCode().isEmpty())
                                                .findFirst()
                                                .orElse(null);
