package com.workflow.process.definition.infrastructure.flowable;

import com.workflow.process.definition.application.ProcessBpmnSynchronousExecutionNormalizer;
