...
import com.workflow.config.web.CorsProperties;
import com.workflow.config.web.WebAccessConfiguration;
...
@Import({
        com.workflow.config.database.MySqlErrorTestConfiguration.class,
        EmbedRuntimeSecurityConfiguration.class,
        WebAccessConfiguration.class,
