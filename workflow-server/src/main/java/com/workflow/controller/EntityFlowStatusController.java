 ...
 */
@RestController
@RequestMapping("/api/entity-flow-status")
...
public class EntityFlowStatusController {
     ...
     * 保存流程状态映射配置
     */
    @PostMapping("/save/{processConfigId}")
     ...
     * 查询流程的状态映射配置
     */
    @GetMapping("/list/{processConfigId}")
     ...
     * 根据流程标识查询
     */
    @GetMapping("/list/by-key/{processKey}")
     ...
     * 删除流程的状态映射配置
     */
    @DeleteMapping("/delete/{processConfigId}")
