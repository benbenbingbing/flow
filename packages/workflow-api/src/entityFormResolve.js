...
export function createEntityFormResolveApi(request) {
 ...
 * @returns 表单信息，包含表单字段
 */
function getFormForNewData(entityCode, config = {}) {
 ...
 */
function getFormForViewData(entityCode, entityDataId) {
  return request.get(`/entity-form-resolve/view-data/${entityCode}/${entityDataId}`)
}

return { getFormForNewData, getFormForViewData }
}
